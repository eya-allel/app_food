...
import { FiArrowLeft, FiEdit2, FiTrash2, FiMaximize, FiX, FiClock, FiList, FiTag } from 'react-icons/fi';
      ...
      <div className="bg-white rounded-lg shadow-lg overflow-hidden border border-gray-100">
        ...
        <div className="p-8">
          <div className="flex justify-between items-start mb-6">
            <div>
              <h1 className="text-4xl font-bold text-gray-800 transition-colors duration-300">{recipe.name}</h1>
              {recipe.category && (
                <div className="mt-2 flex items-center">
                  <FiTag className="text-amber-500 mr-1" />
                  <span className="text-amber-600 font-medium">{recipe.category}</span>
                </div>
              )}
            </div>
